...
def dashboard_candidato():
    ...
    cursor.execute(
        '''
        SELECT pretensao_salarial, resumo_profissional, endereco, cep, nome
        FROM candidatos
        WHERE id = %s
        ''',
    ...
    return render_template(
        ...
        candidato_nome=candidato_nome  # envia o nome seguro para o template
    )
...
def editar_perfil_candidato():
    ...
    if request.method == 'POST':
        ...
        # Lidar com o upload de currículo
        file = request.files.get('curriculo')
        caminho_curriculo = None  # Inicialmente não há caminho para o currículo
        ...
        """, (
            ...
            caminho_curriculo, formacao, endereco, numero,
            complemento, cep, candidato_id
        ))
    ...
    cursor.execute("""
        SELECT nome, telefone, linkedin, pretensao_salarial,
               experiencia, competencias, resumo_profissional, formacao, 
               endereco, numero, complemento, cep, caminho_curriculo
