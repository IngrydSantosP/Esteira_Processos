...
def processar_upload_curriculo(request, candidato_id):
    ...
    try:
        ...
        nome_arquivo_final = f"candidato_{candidato_id}_{nome_arquivo}"
        caminho_arquivo = os.path.join(UPLOAD_FOLDER, nome_arquivo_final)
        ...
        cursor.execute('''
            ...
            WHERE id = ?
        ''', (texto_curriculo, nome_arquivo_final, candidato_id))
